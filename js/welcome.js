...
$.ajax({
    ...
    data: {
        key: 'WNXBZ-E2UW4-VZNU4-DEI6B-XI5JF-MDBBU',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(23.544204, 113.591899, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
